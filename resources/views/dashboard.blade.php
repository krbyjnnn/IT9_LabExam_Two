                ...
                <div class="p-6">
                    ...
                    <div style="display: flex; gap: 1.5rem;">
                        <div style="flex: 1; padding: 2rem; background-color: #374151; border-radius: 0.75rem; display: flex; flex-direction: column; align-items: center; text-align: center;">
                            ...
                            <p style="color: #9ca3af; font-size: 0.875rem;">Manage your rice inventory and pricing here.</p>
                        </div>
                        ...
                        <div style="flex: 1; padding: 2rem; background-color: #374151; border-radius: 0.75rem; display: flex; flex-direction: column; align-items: center; text-align: center;">
                            ...
                            <p style="color: #9ca3af; font-size: 0.875rem;">Place a new customer order.</p>
                        </div>
